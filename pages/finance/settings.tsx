...
const FinanceSettingsPage: NextPage = () => {
  ...
  const [accountJournals, setAccountJournals] = useState<AccountJournal[]>(mockAccountJournalsData);
            ...
            <Card className="border-orange-100 overflow-hidden neo-shadow relative">
              ...
              <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50 border-b border-orange-100 pb-2">
                <div className="flex items-center">
                  ...
                  <div>
                    <CardTitle className="text-lg font-bold text-orange-800">Pengaturan Umum</CardTitle>
