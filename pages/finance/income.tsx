...
const FinanceIncomePage: NextPage = () => {
  ...
  const prepareExportData = () => {
    return mockIncomeTransactions.map(income => ({
      ID: income.id,
      Tanggal: income.date,
  ...
  const [viewIncomeDialog, setViewIncomeDialog] = useState<boolean>(false);
  const [editIncomeDialog, setEditIncomeDialog] = useState<boolean>(false);
  const [addIncomeDialog, setAddIncomeDialog] = useState<boolean>(false);
  ...
  useEffect(() => {
    ...
    const total = mockIncomeTransactions.reduce((sum, transaction) => sum + transaction.amount, 0);
  ...
  const sortedIncomes = getSortedItems(mockIncomeTransactions);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Here you would typically make an API call to save the income
  ...
  // Function to handle update income
  const handleUpdateIncome = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulasi update income
          ...
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-gray-800">Rp{totalIncome.toLocaleString('id-ID')}</h3>
          ...
          <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50 border-b border-orange-100 pb-2">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  onClick={() => setAddIncomeDialog(true)}
              ...
              <div className="mt-8 border-t border-orange-100 pt-6 flex items-center justify-between">
                ...
                <div className="flex gap-3">
                  <Button 
                    type="button"
                    variant="outline" 
                    onClick={() => setAddIncomeDialog(false)} 
        ...
        <DialogContent className="p-0 max-w-5xl max-h-[90vh] overflow-y-auto border-orange-200">
          ...
          <div className="p-6 relative z-10">
            <DialogHeader className="mb-4 flex flex-row items-center">
              <div className="h-12 w-1.5 bg-gradient-to-b from-orange-500 to-amber-500 rounded-full mr-4"></div>
              <div>
                <DialogTitle className="text-2xl font-bold text-orange-800">Edit Pemasukan</DialogTitle>
                <DialogDescription className="text-orange-600">
                  Perbarui informasi detail pemasukan
                </DialogDescription>
              </div>
            </DialogHeader>

            <form onSubmit={handleUpdateIncome} className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Left Column */}
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-orange-50 to-amber-50 p-5 rounded-lg border border-orange-100">
              ...
              <div className="mt-8 border-t border-orange-100 pt-6 flex items-center justify-between">
                <div className="text-sm text-gray-500">
                  <span className="flex items-center">
                    <FaInfoCircle className="h-4 w-4 mr-2 text-orange-400" />
                    Semua perubahan akan tercatat dalam buku kas dan laporan keuangan
                  </span>
                </div>
                <div className="flex gap-3">
                  <Button 
