...
export function MultiSelect({
  ...
  return (
    ...
    >
      <div className="group rounded-md border border-input px-3 py-1 text-sm ring-offset-background focus-within:ring-1 focus-within:ring-ring focus-within:ring-offset-2">
