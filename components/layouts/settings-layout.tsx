...
const SettingsLayout = ({ children, showBackButton = true }: SettingsLayoutProps) => {
  ...
  const navItems = [
    { name: 'Beranda', path: '/settings', icon: <FaHome className="w-4 h-4" /> },
    { name: 'Karyawan', path: '/settings/employees', icon: <FaUsers className="w-4 h-4" /> },
    { name: 'Cabang', path: '/settings/branches', icon: <FaBuilding className="w-4 h-4" /> },
    { name: 'Jadwal & Shift', path: '/settings/schedules', icon: <FaCalendarAlt className="w-4 h-4" /> },
    { name: 'Roles & Akses', path: '/settings/roles', icon: <FaUserShield className="w-4 h-4" /> },
    { name: 'Pengaturan Umum', path: '/settings/general', icon: <FaCog className="w-4 h-4" /> }
  ];
