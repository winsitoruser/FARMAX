            ...
            <div className="flex items-center justify-between">
              ...
              <div className="h-12 w-12 rounded-full bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-green-600">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm3 0h.008v.008H18V12m0 0h-.008v.008H21v-.008Z" />
                </svg>
              </div>
            </div>
            <div className="mt-4 flex items-center text-sm">
          ...
          <CardContent className="p-6 relative z-10">
            ...
            <div className="mt-4 flex items-center text-sm">
              <span className="text-amber-600 font-medium flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm3 0h.008v.008H18V12m0 0h-.008v.008H21v-.008Z" />
                </svg>
                5 mendesak
              </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6">
          <Card className="border-orange-100 shadow-md bg-gradient-to-br from-white to-orange-50/50 overflow-hidden">
            ...
            <CardHeader className="border-b border-orange-100/50 pb-3 relative">
              ...
              <p className="text-xs text-gray-500 mt-1">Tarik item ke formulir pesanan atau klik tombol "+"</p>
