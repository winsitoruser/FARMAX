...
export default function DefectaList({ onDragStart, onAddItemToPO }: DefectaListProps) {
  ...
  return (
    <div className="w-full">
      {/* Search bar */}
      <div className="p-3 border-b border-orange-100/50 bg-white">
            ...
            {filteredItems.length > 0 ? (
              filteredItems.map((item) => (
                <TableRow 
                  ...
                  className="hover:bg-orange-50/50 cursor-grab transition-colors duration-200"
                >
              ...
              <TableRow>
                <TableCell colSpan={5} className="text-center py-6 text-gray-500">
                  <div className="flex flex-col items-center">
                    <FaInfoCircle className="text-amber-400 h-10 w-10 mb-2" />
