...
import { Product, mockCategories, mockStocks, StockTransaction, mockProductConsumptionStats } from "../types";
...
const ProductDetail: React.FC<ProductDetailProps> = ({ product, onClose, onEdit }) => {
  ...
  // Find consumption stats for this product
  ...
  return (
    <div className="relative">
      ...
      <div className="overflow-hidden w-full" style={{ maxWidth: '850px' }}>
        {/* Card Container with Pharmaceutical Style */}
        <div className="bg-white rounded-xl shadow-xl relative overflow-hidden flex flex-col">
          {/* Decorative Elements */}
          ...
          <Tabs defaultValue="info" value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
            <div className="px-5 pt-4 border-b border-orange-100">
              <TabsList className="grid w-full grid-cols-4 bg-orange-50 p-0.5">
                <TabsTrigger 
                  value="info" 
                ...
                <TabsTrigger 
                  ...
                  className="py-2 text-sm font-medium data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-amber-500 data-[state=active]:text-white"
                >
                  <FaCalculator className="mr-2 h-3.5 w-3.5" /> Kalkulator Stok
                </TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value="info" className="flex-1 overflow-y-auto p-0 m-0">
              <div className="p-5">
                ...
                <div className="bg-gradient-to-r from-orange-50/80 to-white rounded-lg border border-orange-100 overflow-hidden mt-4">
                  <div className="flex items-center px-3 py-2 border-b border-orange-100 bg-gradient-to-r from-orange-100/50 to-white">
                    <FaWarehouse className="text-orange-500 mr-2" size={14} />
                    <h3 className="font-medium text-orange-800 text-sm">Inventori & Riwayat</h3>
                  </div>
                  ...
                  <div className="p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-sm text-gray-700 flex items-center">
                          <FaBoxes className="text-orange-500 mr-2" size={14} />
                          Stok
                        </div>
                        <div className="flex items-center text-sm text-gray-900 max-w-[170px] truncate">
                          {stockInfo?.currentStock || 0} {product.unit}
                        </div>
                      </div>
            ...
            <TabsContent value="calculator" className="flex-1 overflow-y-auto p-0 m-0">
              <div className="p-5">
                {stockInfo ? (
                  <StockCalculator 
                    product={product}
                  ...
                  <div className="flex flex-col items-center justify-center p-6 text-center h-full">
                    <FaExclamationTriangle className="h-12 w-12 text-amber-400 mb-4" />
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Data Stok Tidak Tersedia</h3>
                    <p className="text-gray-500 max-w-md">
                      Informasi stok tidak ditemukan untuk produk ini. Kalkulator stok membutuhkan data stok untuk melakukan perhitungan.
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="p-4 border-t border-orange-100 bg-gradient-to-r from-orange-50 to-white">
            <div className="flex flex-wrap gap-3">
              <Button 
                className="flex-1 min-w-[120px] bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white border-0 shadow-sm"
                onClick={() => onEdit && onEdit(product)}
              >
                <FaEdit className="mr-1.5 h-4 w-4" /> Edit Produk
              </Button>
              
              <Button 
                className="flex-1 min-w-[120px] bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white border-0 shadow-sm"
              >
                <FaShoppingCart className="mr-1.5 h-4 w-4" /> Buat PO
              </Button>
              
              <Button 
                variant="outline"
                className="min-w-[100px] border-orange-200 text-orange-700 hover:bg-orange-50"
                onClick={onClose}
              >
                <FaTimes className="mr-1.5 h-4 w-4" /> Tutup
              </Button>
            </div>
          </div>
        </div>
